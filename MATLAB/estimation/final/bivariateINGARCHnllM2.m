function [nll, grad] = bivariateINGARCHnllM2(theta, data)
    omega1 = theta(1);
    alpha11 = theta(2);
    beta11 = theta(3);
    omega2 = theta(4);
    ...
    for t = 1:n
        ...
        grad(4) = grad(4) + (term2 * d_lambda2_d_omega2(t));
        grad(5) = grad(5) + (term2 * d_lambda2_d_alpha22(t));
        grad(6) = grad(6) + (term2 * d_lambda2_d_beta22(t));
