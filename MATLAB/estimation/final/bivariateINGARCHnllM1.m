function [nll, grad] = bivariateINGARCHnllM1(theta, data)
    omega1 = theta(1);
    alpha11 = theta(2);
    alpha12 = theta(3);
    beta11 = theta(4);
    ...
    for t = 1:n
        ...
        grad(5) = grad(5) + (term1 * d_lambda1_d_beta12(t));
        % Gradient w.r.t theta_2
        grad(6) = grad(6) + (term2 * d_lambda2_d_omega2(t));
        grad(7) = grad(7) + (term2 * d_lambda2_d_alpha21(t));
        grad(8) = grad(8) + (term2 * d_lambda2_d_alpha22(t));
        grad(9) = grad(9) + (term2 * d_lambda2_d_beta21(t));
        grad(10) = grad(10) + (term2 * d_lambda2_d_beta22(t));
